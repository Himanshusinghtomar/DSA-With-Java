...
//        p.binaryPattern(5);
//        p.numberCrownPattern(5);
        p.increasingNumberTrianglePattern(5);
    }
    ...
    public void increasingNumberTrianglePattern(int N) {
        for (int i = 0; i <= N; i++)
        {
            for(int j =0;j<=i;j++)
            {
    ...
    public void increasingLetterTrianglePattern(int N) {
        for (int i = 1; i <= N; i++)
        {
            for(int j =1;j<=i;j++)
            {
